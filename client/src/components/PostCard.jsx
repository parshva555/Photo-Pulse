  ...
  return (
    <div className="mb-2 bg-primary p-4 rounded-xl">
      ...
      <div className="mt-4 flex justify-between items-center px-3 py-2 text-ascent-2 text-base border-t border-[#66666645]">
        <p className="flex gap-2 items-center text-base curson-pointer">
        ...
        <p
          className="flex gap-2 items-center text-base curson-pointer"
          onClick={() => {
            setShowComments(showComments === post?.id ? null : post._id);
